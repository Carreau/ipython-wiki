...
(http://nbviewer.ipython.org/url/epi.whoi.edu/ipython/results/mdistefano/The_Perfect_Storm_1991.ipynb). Using NetCDF, Matplotlib, IPython Parallel and ffmpeg to generate video animation from time series of gridded data. By Massimo Di Stefano.
